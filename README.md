...
```diff
- ! alert
@@ If the solutions passed all the test cases and is written in C language with 42 school header included, then only it will be consider as a valid solution.@@
```
<h2>
...
Repository is used for the prepration of C - beginner exam in 42 School Silicon Valley.
It contains all of the Beginner Questions and solutions to it.
...
5. Located at various directory distinguished by there difficulty levels and 
see the subject.en.txt to undertsand the question and for solutions see the *.c files 
and there working.
